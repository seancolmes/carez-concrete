...
export const metadata = {
  ...
  metadataBase: new URL("https://carezconcrete.com"),
};
    ...
    <footer className="border-t border-neutral-800 bg-neutral-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-3 gap-8 text-sm">
        ...
        <div className="text-neutral-300">
          ...
          <div className="mt-2">
            <a className="underline decoration-neutral-700 hover:decoration-neutral-400" href="mailto:nik@carezconcrete.com">
              nik@carezconcrete.com
            </a>
          </div>
          <div>
            <a className="underline decoration-neutral-700 hover:decoration-neutral-400" href="tel:+12536175505">
              (253) 617-5505
            </a>
          </div>
        </div>
      ...
      <div className="py-6 text-center text-xs text-neutral-500">
        © {new Date().getFullYear()} Carez Concrete LLC. All rights reserved.
      </div>
...
export default function RootLayout({ children }) {
  const localBusinessJsonLd = {
    ...
    name: "Carez Concrete",
    url: "https://carezconcrete.com",
    image: "https://carezconcrete.com/logo.png",
